"""Integration tests for min_variance_gtaa.
...
def test_backtest_runs_end_to_end_with_mocked_yfinance() -> None:
    ...
    assert result.meta["strategy"] == "min_variance_gtaa"
    assert result.meta["paper_doi"] == "10.3905/jpm.1991.409335"
...
def test_backtest_rejects_empty_prices() -> None:
    ...
    with pytest.raises(ValueError, match="empty"):
        vectorbt_bridge.run(strategy=MinVarianceGtaa(), prices=empty)
