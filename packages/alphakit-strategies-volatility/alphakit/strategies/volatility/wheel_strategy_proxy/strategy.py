"""Wheel strategy proxy (practitioner folklore).
...
class WheelStrategyProxy:
    """WheelStrategyProxy — vol-selling proxy via realized-vol overlay."""

    name: str = "wheel_strategy_proxy"
    family: str = "volatility"
    asset_classes: tuple[str, ...] = ("equity",)
    paper_doi: str = "practitioner-no-formal-doi"
