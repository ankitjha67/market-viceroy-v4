"""Systematic iron condor proxy (Israelov & Nielsen 2014).
...
class IronCondorSystematicProxy:
    """IronCondorSystematicProxy — vol-selling proxy via realized-vol overlay."""

    name: str = "iron_condor_systematic_proxy"
