"""Covered call / buy-write proxy (Whaley 2002).
...
class CoveredCallProxy:
    """CoveredCallProxy — vol-selling proxy via realized-vol overlay."""

    name: str = "covered_call_proxy"
    family: str = "volatility"
    asset_classes: tuple[str, ...] = ("equity",)
    paper_doi: str = "10.3905/jod.2002.319188"
