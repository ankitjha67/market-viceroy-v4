"""Price-to-earnings value (Basu 1977).

Reference
---------
Basu, S. (1977). Investment Performance of Common Stocks in Relation
to Their Price-Earnings Ratios. *Journal of Finance*, 32(3), 663-682.
DOI: 10.1111/j.1540-6261.1977.tb01979.x.

**Phase 1 proxy**: Long-term reversal as earnings-yield proxy.
Stocks with low trailing returns tend to have high E/P. See ADR-001.
"""
...
class PEValue:
    """P/E value — cross-sectional long/short via reversal proxy."""

    name: str = "pe_value"
    family: str = "value"
    asset_classes: tuple[str, ...] = ("equity",)
    paper_doi: str = "10.1111/j.1540-6261.1977.tb01979.x"
