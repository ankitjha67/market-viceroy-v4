"""mv-api — FastAPI backend and WebSocket streams; Operator-authed mutating endpoints.

Phase: Phase 1. This is a Phase-0 typed skeleton: package boundary, version,
