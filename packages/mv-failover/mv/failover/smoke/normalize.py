...
No I/O, no clock, no network — so it is trivially unit-testable and is the
part of the smoke that carries the coverage gate. The I/O that surrounds it
lives in :mod:`mv.failover.smoke.pipeline`.
"""
